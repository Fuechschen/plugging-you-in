...
class Client extends EventEmitter {
    ...
    addUser(userID) {
        return new Promise((resolve, reject) => {
            ...
            this._requestAgent.request('post', Constants.endpoints.addBooth, {id: userID}).then(resolve, reject);
        });
    }
    ...
    removeUser(userID) {
        return new Promise((resolve, reject) => {
            ...
            this._requestAgent.request('delete', Constants.endpoints.remove + userID).then(resolve, reject);
        });
    }
    ...
    moveUser(userID, position) {
        return new Promise((resolve, reject) => {
            ...
            this._requestAgent.request('delete', Constants.endpoints.move, {
                userID,
                position
            }).then(resolve, reject);
        });
